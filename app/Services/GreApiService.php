...
class GreApiService
{
    ...
    public function __construct()
    {
        ...
        if (strtoupper($ambiente) === 'BETA') {
            // API oficial de SUNAT BETA
            $this->baseUrl = 'https://api-cpe.sunat.gob.pe/v1/contribuyente/gem';
        } else {
            // API oficial de SUNAT PRODUCCIÓN
            $this->baseUrl = 'https://api-cpe.sunat.gob.pe/v1/contribuyente/gem';
        }

        $this->username = env('GREENTER_FE_USER', '20000000001MODDATOS');
        $this->password = env('GREENTER_FE_PASSWORD', 'MODDATOS');
